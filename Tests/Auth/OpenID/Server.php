...
class Tests_Auth_OpenID_CheckID extends PHPUnit_Framework_TestCase {
    ...
    function test_answerAllowAnonymousFail()
    {
        ...
        $this->assertTrue($this->request->answer(true, null, "=V") instanceof Auth_OpenID_ServerError);
    }
    ...
    function test_answerAllowWithDelegatedIdentityOpenID1()
    {
        ...
        $this->assertTrue(($result instanceof Auth_OpenID_ServerError), var_export($result, true));
    }
